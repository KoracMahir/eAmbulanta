...
var FilterBuilder = _ui2.default.inherit({
    ...
    _addDocumentClick: function($editor, closeEditorFunc) {
        ...
        var documentClickHandler = function(e) {
            if (!_this3._isFocusOnEditorParts($editor, e.target)) {
    ...
    _createValueEditorWithEvents: function(item, field, $container) {
        ...
        var document = _dom_adapter2.default.getDocument(),
            ...
            createValueText = function() {
                $container.empty();
                removeEvents();
                return _this4._createValueText(item, field, $container)
            },
            closeEditor = function() {
                _this4._updateConditionValue(item, value, function() {
                    createValueText()
                })
            };
        var options = {
        ...
        var documentKeyUpHandler = this._addDocumentKeyUp($editor, function(e) {
            if (e.keyCode === TAB_KEY) {
                if (_this4._isFocusOnEditorParts($editor)) {
                    return
                }
                _this4._updateConditionValue(item, value, function() {
                    createValueText();
